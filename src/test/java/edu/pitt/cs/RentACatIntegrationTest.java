...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() throws Exception {
		...
		Cat result = (Cat) getCatMeth.invoke(r, 2);
		assertNull("Return value is not null", result);
	...
	public void testGetCatNumCats3() throws Exception{
		...
		getCatMeth.setAccessible(true);
		Cat result = (Cat) getCatMeth.invoke(r, 2);
		assertNotNull("Returned value is null",result);
		assertEquals("Returned ID was not equal to 2",2, result.getId());
	}
	...
	public void testListCatsNumCats0() {
		...
		assertEquals("Return value is not \"\"", "", retStr);
	}
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c3);
		String retStr = r.listCats();
		assertEquals("Return value isn't a proper list of added cats", "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", retStr);
	}
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse("The returned value is true", ret);
		assertEquals("Invalid System output", "Invalid cat ID.", out.toString().trim());
	}
	...
	public void testRenameNumCat3() {
		...
		r.addCat(c3);
		boolean ret = r.renameCat(2, "Garfield");
		assertTrue("The returned value is false", ret);
		assertEquals("The cat has not been renamed Garfield", "Garfield", c2.getName());
	}
	...
	public void testRentCatNumCats3() {
		...
		assertTrue("c2 has not been rented", c2.getRented());
	...
	public void testRentCatFailureNumCats3() {
		...
		assertTrue("c2 is not rented", c2.getRented());
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("The return value is false", ret);
		assertFalse("c2 was not returned", c2.getRented());
	...
	public void testReturnFailureCatNumCats3() {
		...
		boolean ret = r.returnCat(2);
		assertFalse("Return value is true", ret);
		assertFalse("c2 is rented", c2.getRented());
